...
The cluster module defines shared tooling in [`.github/sdlc.src.yaml`](https://github.com/EspenAlbert/terraform-mongodbatlas-cluster-wip/blob/v0.12.0/.github/sdlc.src.yaml). The `path-sync` tool copies files one-way from cluster to destination modules.

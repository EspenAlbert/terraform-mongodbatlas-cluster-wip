...
See [test-guide.md](https://github.com/EspenAlbert/terraform-mongodbatlas-cluster-wip/blob/v0.10.0/contributing/test-guide.md) for detailed testing documentation including:
...
**Note**: Cross-variable validation references are a key reason this module requires Terraform >= 1.9. See [Terraform Version Requirements](https://github.com/EspenAlbert/terraform-mongodbatlas-cluster-wip/blob/v0.10.0/contributing/docs/terraform_version_requirements.md) for details.
...
See [documentation-guide.md](https://github.com/EspenAlbert/terraform-mongodbatlas-cluster-wip/blob/v0.10.0/contributing/documentation-guide.md) for detailed documentation contributor guidelines.

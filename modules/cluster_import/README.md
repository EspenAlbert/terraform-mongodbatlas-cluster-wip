...
module "cluster_import" {
  source  = "EspenAlbert/cluster-wip/mongodbatlas//modules/cluster_import"
  version = "0.10.0"
...
- See the [example](https://github.com/EspenAlbert/terraform-mongodbatlas-cluster-wip/blob/v0.10.0/examples/13_example_import) for a complete working example

...
Most examples in this repository use the simplified `regions` approach. Refer to the [Examples section in the main README](https://github.com/EspenAlbert/terraform-mongodbatlas-cluster-wip/blob/v0.12.0/README.md#examples) which provides two organized tables:
...
See [`examples/09_cluster_using_replication_specs`](https://github.com/EspenAlbert/terraform-mongodbatlas-cluster-wip/blob/v0.12.0/examples/09_cluster_using_replication_specs) for a complete example of using the `replication_specs` variable directly with manual scaling.
...
- See example in [Production Cluster with Manual Scaling](https://github.com/EspenAlbert/terraform-mongodbatlas-cluster-wip/blob/v0.12.0/examples/02_production_cluster_with_manual_scaling)
...
For troubleshooting common issues and additional help, see the FAQ and Troubleshooting sections in the [main README](https://github.com/EspenAlbert/terraform-mongodbatlas-cluster-wip/blob/v0.12.0/README.md#faq).

## Additional Resources

- **[Main Module README](https://github.com/EspenAlbert/terraform-mongodbatlas-cluster-wip/blob/v0.12.0/README.md)** - Complete module documentation with all variables and outputs
- **[Examples Directory](https://github.com/EspenAlbert/terraform-mongodbatlas-cluster-wip/blob/v0.12.0/examples)** - Working examples for all deployment patterns
